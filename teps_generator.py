...
반드시 지켜야 할 규칙:
1. 출력에 사용할 수 있는 문자는 영어(알파벳)와 한국어(한글)만 허용합니다.
2. 한자, 힌디 문자, 아랍 문자, 일본어 등 다른 언어 문자는 절대 사용하지 마세요.
3. 이모티콘(emoji)은 절대 사용하지 마세요. 텍스트로만 표현하세요.
4. 출력은 반드시 지정된 마크다운 형식을 엄격히 따르세요."""

USER_PROMPT_TEMPLATE = """오늘 날짜: {date}

다음 형식으로 TEPS 일일 학습 콘텐츠를 작성해주세요.
회사 쉬는 시간 10~15분 안에 볼 수 있는 분량으로 만들어주세요.
사용 가능한 문자: 영어, 한국어만. 이모티콘 사용 금지.
...
위 단어 5개를 활용한 빈칸 채우기 문제 3개를 만드세요.

**Q1.** [빈칸이 포함된 영어 문장. 보기 4개 제시: (A) (B) (C) (D)]

**Q2.** [빈칸이 포함된 영어 문장. 보기 4개 제시: (A) (B) (C) (D)]

**Q3.** [빈칸이 포함된 영어 문장. 보기 4개 제시: (A) (B) (C) (D)]
...
**지문:**
[100~150단어 분량의 영어 지문. TEPS 독해 난이도 반영. 시사/경제/과학/환경 주제 중 선택.]
